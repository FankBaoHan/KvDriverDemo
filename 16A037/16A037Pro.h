...
#include "serialcom.h"
/////////////////////////////////////////////////////////////////////////////
// C16A037Pro command target

class C16A037Pro : public CCmdTarget
{
	DECLARE_DYNCREATE(C16A037Pro)		
	C16A037Pro();           // protected constructor used by dynamic creation
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_OLECREATE(C16A037Pro)		
	// Generated OLE dispatch map functions
	//{{AFX_DISPATCH(C16A037Pro)
	// NOTE - the ClassWizard will add and remove member functions here.
	//}}AFX_DISPATCH
